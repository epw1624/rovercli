...
sync_parser.add_argument("--src-root", type=str, default="/home/rv/Roverflake2/", help="Sync source (Roverflake root)")
sync_parser.add_argument("--dst-root", type=str, default="/home/rv/Roverflake2/", help="Sync remote destination (Roverflake root)")
